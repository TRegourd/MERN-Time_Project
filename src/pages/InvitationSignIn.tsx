...
function InvitiationSignIn() {
  ...
  function handleSubmit(e: React.MouseEvent<HTMLElement>) {
    e.preventDefault();
    console.log({ ...body, team: [params.id] });

    services
      .signin({ ...body, team: [params.id] })
      .then(() => {
  ...
  return (
    <div>
      ...
      <CardWrapper>
        <CardHeader>
          <CardHeading>Sign in as a Single User</CardHeading>
        </CardHeader>
...
export default InvitiationSignIn;
